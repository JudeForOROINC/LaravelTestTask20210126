...
{{--                            //need in check for admin or logged user--}}
                            ...
                            <li>
                                <a class="nav-item nav-link{{ substr(Route::currentRouteName(),0,13)=='soundcategory'?' active':'' }}"
                                   href="{{ url('/soundcategory') }}">Sound Categories</a>
                            </li>
                            <li>
                                <a class="nav-item nav-link{{ substr(Route::currentRouteName(),0,10)=='complaints'?' active':'' }}"
